...
var apiKey = "&api_key=MzS1nCKysUbxu85KTHa8WLYbeOvjiDAu";
var limit = "&limit=5";


var gifRating = response.data.rating;
var gifStill = response.data.fixed_height_still.url;
var gifAnimated = response.data.fixed_height.url;


var queryURL = url + pets[i] + apiKey + limit;
